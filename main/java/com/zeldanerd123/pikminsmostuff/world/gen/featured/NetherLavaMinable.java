package com.zeldanerd123.pikminsmostuff.world.gen.featured;
...
public class NetherLavaMinable extends WorldGenerator
{
    ...
    public NetherLavaMinable(Block p_i45459_1_, int p_i45459_2_)
    {
        this(p_i45459_1_, p_i45459_2_, Blocks.lava);
        
    }

    public NetherLavaMinable(Block p_i45460_1_, int p_i45460_2_, Block p_i45460_3_)
    {
    ...
    public NetherLavaMinable(Block block, int meta, int number, Block target)
    {
